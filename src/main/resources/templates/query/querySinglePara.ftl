...
<#include "../components/sider.ftl" />
    <div id="page-wrapper">
        <div class="row">
            <div class="col-md-12">
                <h2 align="center">单项参数查询</h2>
            </div>
        </div>
        <hr/>
        <form role="form" action="${request.contextPath}/resultSinglePara" method="post">
            ...
            <div class="form-group">
                <label>来源版本</label>
                <select class="form-control" id="lybb1" name="version">
                    <option>---请选择---</option>
                    <option value="0">全部</option>
                    <option value="1">可研报告版</option>
                    <option value="2">管道公司申报版</option>
                    <option value="3">经济评价参数版</option>
                </select>
            </div>
